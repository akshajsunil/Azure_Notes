...
* Azure File Sync : Sunc Azure files with on-premises File servers
...
All users are Trustworthy until proven Otherwise
...
## Azure Active Directory Fomain Services (AADDS)
...
2. Protect Resorces through monitering 
...
2. cutom alerts for planned and unplanned outages
...
Tags -  Non-functional labels that can be attachewd to any resource.
